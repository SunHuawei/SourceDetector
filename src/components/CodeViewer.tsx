...
const KEYWORD_PATTERN =
  /\b(const|let|var|function|return|if|else|for|while|switch|case|break|continue|export|import|from|class|new|try|catch|finally|throw|await|async|interface|type)\b/g;
      ...
      >
        ...
        <Stack direction="row" spacing={1} alignItems="center">
          <Chip
            ...
            sx={{ bgcolor: '#2D2D30', color: '#D4D4D4' }}
          />
