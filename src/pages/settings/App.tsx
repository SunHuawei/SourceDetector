...
import { MESSAGE_TYPES, STORAGE_LIMITS } from '@/background/constants';
                ...
                <List>
                    ...
                    <ListItem>
                        <ListItemText
                            ...
                            secondary={`Clean up when storage exceeds ${settings?.cleanupThreshold ?? 500} MB`}
                        />
                        <ListItemSecondaryAction sx={{ width: '50%' }}>
                            <Slider
                                value={settings?.cleanupThreshold ?? 500}
                                min={STORAGE_LIMITS.MIN_CLEANUP_THRESHOLD}
                                max={STORAGE_LIMITS.MAX_CLEANUP_THRESHOLD}
                                step={100}
                    ...
                    <ListItem>
                        ...
                        <ListItemSecondaryAction sx={{ width: '50%' }}>
                            <Slider
                                ...
                                min={STORAGE_LIMITS.MIN_RETENTION_DAYS}
                                max={STORAGE_LIMITS.MAX_RETENTION_DAYS}
                                step={1}
                    ...
                    <ListItem>
                        ...
                        <ListItemSecondaryAction sx={{ width: '50%' }}>
                            <Slider
                                ...
                                min={STORAGE_LIMITS.MIN_FILE_SIZE}
                                max={STORAGE_LIMITS.MAX_FILE_SIZE}
                                step={1}
